# FastGraphics3 Roadmap 🗺️

**Vision:** To provide the fastest possible native primitives for 3D graphics by aggressively bypassing bottlenecks in standard Java.
