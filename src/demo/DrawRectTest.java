...
/**
 * DrawRect Vergleichstest - AWT Graphics2D vs FastGraphics
 * Testet drawRect() (Rechteck-Outline) in beiden Implementierungen
 */
public class DrawRectTest {
    ...
    public static void main(String[] args) {
        ...
        JFrame fgFrame = new JFrame("FastGraphics - drawRect Test");
        ...
        // AWT Fenster (rechts)
        JFrame awtFrame = new JFrame("AWT Graphics2D - drawRect Test");
        ...
        for (int i = 0; i < 20 && hwnd == 0; i++) {
            ...
            hwnd = findWindow("FastGraphics - drawRect Test");
        }
        ...
        System.out.println("DrawRect Vergleichstest läuft...");
        ...
        while (fgFrame.isVisible()) {
            ...
            // Gefüllte rote Rechtecke
            fillRectNative(50, 50, 200, 100, 1.0f, 0.0f, 0.0f);
            fillRectNative(300, 50, 200, 100, 1.0f, 0.0f, 0.0f);

            // Gefüllte grüne Rechtecke
            fillRectNative(50, 200, 200, 100, 0.0f, 1.0f, 0.0f);
            fillRectNative(300, 200, 200, 100, 0.0f, 1.0f, 0.0f);

            // Gefüllte blaue Rechtecke
            fillRectNative(50, 350, 200, 100, 0.0f, 0.0f, 1.0f);
            fillRectNative(300, 350, 200, 100, 0.0f, 0.0f, 1.0f);

            // Outline gelbe Rechtecke
            drawRectNative(550, 50, 200, 100, 1.0f, 1.0f, 0.0f);
            drawRectNative(550, 200, 200, 100, 1.0f, 1.0f, 0.0f);
            drawRectNative(550, 350, 200, 100, 1.0f, 1.0f, 0.0f);
            ...
            if (g2d != null) {
                ...
                bg.fillRect(50, 50, 200, 100);
                bg.fillRect(300, 50, 200, 100);

                // Gefüllte grüne Rechtecke
                bg.setColor(Color.GREEN);
                bg.fillRect(50, 200, 200, 100);
                bg.fillRect(300, 200, 200, 100);

                // Gefüllte blaue Rechtecke
                bg.setColor(Color.BLUE);
                bg.fillRect(50, 350, 200, 100);
                bg.fillRect(300, 350, 200, 100);

                // Outline gelbe Rechtecke
                bg.setColor(Color.YELLOW);
                bg.drawRect(550, 50, 200, 100);
                bg.drawRect(550, 200, 200, 100);
                bg.drawRect(550, 350, 200, 100);
            ...
            if ((System.currentTimeMillis() / 1000) % 5 == 0) {
                System.out.printf("[DrawRect] FastGraphics: %dms | AWT: %dms | Ratio: %.1fx%n",
